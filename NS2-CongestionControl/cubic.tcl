...
$ns namtrace-all $nf
set traceFile1 [open ./cubic/allTraces.tr w]
$ns trace-all $traceFile1

# cwnd data
set wf1 [open ./cubic/cwnd_1.tr w]
set wf2 [open ./cubic/cwnd_2.tr w]

# goodput data
set gf1 [open ./cubic/goodput_1.tr w]
set gf2 [open ./cubic/goodput_2.tr w]

# # lost data
# set lr1 [open ./cubic/lost_1.tr w]
# set lr2 [open ./cubic/lost_2.tr w]

# # RTT data
# set rttR1 [open ./cubic/rtt_1.tr w]
# set rttR2 [open ./cubic/rtt_2.tr w]
...
proc finish {} {
   ...
   exec xgraph ./cubic/cwnd_1.tr ./cubic/cwnd_2.tr -geometry 800x400 &
   exec xgraph ./cubic/goodput_1.tr ./cubic/goodput_2.tr -geometry 800x400 &
   # exec xgraph ./cubic/rtt_1.tr ./cubic/rtt_2.tr -geometry 800x400 &
   # exec xgraph ./cubic/lost_1.tr ./cubic/lost_2.tr -geometry 800x400 &
	exec nam out.nam &
	exit 0
}
...
$tcp1 set ttl_ 64
$ns at 0.0 "$tcp1 select_ca cubic"
...
$tcp2 set ttl_ 64
$ns at 0.0 "$tcp2 select_ca cubic"
