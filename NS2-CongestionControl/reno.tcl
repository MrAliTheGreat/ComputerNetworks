...
$ns namtrace-all $nf
set traceFile1 [open ./reno/allTraces.tr w]
$ns trace-all $traceFile1

# cwnd data
set wf1 [open ./reno/cwnd_1.tr w]
set wf2 [open ./reno/cwnd_2.tr w]

# goodput data
set gf1 [open ./reno/goodput_1.tr w]
set gf2 [open ./reno/goodput_2.tr w]

# # lost data
# set lr1 [open ./reno/lost_1.tr w]
# set lr2 [open ./reno/lost_2.tr w]

# # RTT data
# set rttR1 [open ./reno/rtt_1.tr w]
# set rttR2 [open ./reno/rtt_2.tr w]
...
proc finish {} {
   ...
   exec xgraph ./reno/cwnd_1.tr ./reno/cwnd_2.tr -geometry 800x400 &
   exec xgraph ./reno/goodput_1.tr ./reno/goodput_2.tr -geometry 800x400 &
   # exec xgraph ./reno/rtt_1.tr ./reno/rtt_2.tr -geometry 800x400 &
   # exec xgraph ./reno/lost_1.tr ./reno/lost_2.tr -geometry 800x400 &
   exec nam out.nam &
   exit 0
}
